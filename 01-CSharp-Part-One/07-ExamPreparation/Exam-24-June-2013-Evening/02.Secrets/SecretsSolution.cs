namespace Secrets
{
    ...
    public class SecretsSolution
    {
        ...
        private static int GetSpecialSum(BigInteger number)
        {
        ...
        private static string GetSecretSequence(BigInteger number, int specialSum)
        {
