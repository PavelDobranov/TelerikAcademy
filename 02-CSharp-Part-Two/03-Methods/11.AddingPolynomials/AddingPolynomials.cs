...
class AddingPolynomials
{
    static void Main()
    {
        ...
        int[] polynomialSumArray = GetPolynomialsSum(firstPolynomialArray, secondPolynomialArray);
    ...
    static int[] GetPolynomialsSum(int[] firstPolynomialArray, int[] secondPolynomialArray)
    {
