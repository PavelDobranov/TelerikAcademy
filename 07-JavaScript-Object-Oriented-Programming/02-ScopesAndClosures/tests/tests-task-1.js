  ...
  describe('"Task 1: Library"', function() {
    ...
    describe('library.books.add', function() {
      ...
      it('expect the book to be returned with generated ID(number greater than 1), when title, ISBN and author are valid', function() {
        var bookToAdd = {
          ...
          book = library.books.add(bookToAdd);
    ...
    describe('library.books.list', function() {
      ...
      it('expect to return empty array, when category is provided and no book in that category is added', function() {
        ...
        expect(library.books.list({ category: book.category + (Math.random() * 1000 + '') })).to.eql([]);
      });
      ...
      it('expect to return array with single book, when category is provided and single book in that category is added', function() {
        ...
        expect(library.books.list({ category: book.category })).to.eql([book]);
      });
      ...
      it('expect to return empty array, when category is provided and there is no book with this category', function() {
        ...
        expect(library.books.list({ category: 'NOT-' + book.category })).to.eql([]);
      });
      ...
      it('expect to return empty array, when author is provided and there is no book of this author', function() {
        ...
        expect(library.books.list({ author: 'NOT-' + book.author })).to.eql([]);
      });
    });
